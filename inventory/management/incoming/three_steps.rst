...
into a quality area for quality control (QC). When the quality check has been completed, the goods move 
...
In receipt order, products are always considered available because they come from the supplier. 
...
Once the receipt has been validated, the transfer to quality becomes *Ready*. Because the documents 
...
Now, the transfer that enters the products into stock is *Ready*. Here, it is again ready to be 
